<div
    id="import-student-identity-popup" tabindex="-1"
    ...
    <div class="bg-white w-full max-w-md max-h-full relative rounded-lg shadow dark:bg-gray-700">
        <div class="px-4 mx-auto max-w-2xl lg:py-8">
            ...
            <h1 class="title text-3xl text-dark-blue font-bold mb-5 text-center">
               Import Student Identity</h1>
            <form
                class="import-student-identity"
                action="{{route('student-identity.import')}}"
                enctype="multipart/form-data"
                method="POST"
            >
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <!-- Selected student-identity Information -->
                ...
                <div class="flex justify-center space-x-4 mt-10">
                    ...
                    <a
                        data-modal-hide="import-student-identity-popup"
