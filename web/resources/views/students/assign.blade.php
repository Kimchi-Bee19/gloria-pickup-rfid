<div id="assign-student-popup" tabindex="-1"
        ...
        <div class="p-8 mx-auto max-w-2xl">
            ...
            <form class = "assign-identity" action="" method="POST">
                ...
                <div class="flex justify-center space-x-4 mt-10">
                    ...
                    <a data-modal-hide="assign-student-popup"
                        class="assign-student-popup-hide inline-flex items-center px-5 py-2.5 mt-1 text-sm font-medium text-center text-white bg-gray-500 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-gray-600">
                        Cancel
                    </a>
                </div>
            </form>
