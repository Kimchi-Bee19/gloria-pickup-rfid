<div
    id="import-vehicle-popup" tabindex="-1"
    ...
    <div class="bg-white w-full max-w-md max-h-full relative rounded-lg shadow dark:bg-gray-700">
        <div class="px-4 mx-auto max-w-2xl lg:py-8">
            ...
            <h1 class="title text-3xl text-dark-blue font-bold mb-5 text-center">
               Import Vehicle</h1>
            <form
                class="import-vehicle"
                action="{{route('vehicle.import')}}"
            ...
            >
                        ...
                        <div class = "text-sm p-2"> 
                            <div class = "font-bold">Upload file csv, xls, atau xlsx dengan ketentuan sebagai berikut </div>
                                ...
                                <ul class = "list-disc list-inside">
                                    <li>license_plate (nomor plat kendaraan)</li>
                                    <li>type (tipe kendaraan [mobil, motor, dkk])</li>
                                    <li>model (model kendaraan)</li>
                                    <li>color (warna kendaraan)</li>
                                </ul>
                                Kolom yang boleh ada, namun tidak wajib:
                                <ul class = "list-disc list-inside">
                                    <li>license_plate_expiry (bulan kadaluwarsa plat kendaraan)</li>
                                    <li>tag_id (id tag RFID kendaraan)</li>
                                    <li>notes (catatan tag RFID kendaraaan)</li>
                                </ul>
                ...
                <div class="flex justify-center space-x-4 mt-10">
                    ...
                    <a
                        data-modal-hide="import-vehicle-popup"
